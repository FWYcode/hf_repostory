 ...
 */
//@AutoConfigureAfter(ShiroCasParems.class)
//@Import(ShiroCasParems.class)
//@Configuration
public class ShiroConfig {

    public static final String casServerUrlPrefix =ShiroCasParems.casServerUrlPrefix;
    // Cas登录页面地址
    public static final String casLoginUrl = casServerUrlPrefix + ShiroCasParems.casLoginUri;
    // Cas登出页面地址
    public static final String casLogoutUrl = casServerUrlPrefix + ShiroCasParems.casLogoutUri;
    // 当前工程对外提供的服务地址
    public static final String shiroServerUrlPrefix =ShiroCasParems.shiroServerUrlPrefix;
//    static String thisserver;

//    static {
//        shiroServerUrlPrefix = thisserver;
//        System.out.println(shiroServerUrlPrefix);
//    }

    // casFilter UrlPattern
    public static final String casFilterUrlPattern = ShiroCasParems.casFilterUrlPattern;
    // 登录地址
    ...
    // 登录成功地址
    public static final String loginSuccessUrl =ShiroCasParems.loginSuccessUrl;

    // 权限认证失败跳转地址
    public static final String unauthorizedUrl = ShiroCasParems.unauthorizedUrl;
...
//        filterChainDefinitionMap.put("/user/**","myfilter");
    ...
    public MyRealm getMyRealm() {
        ...
        myRealm.setCasServerUrlPrefix(ShiroConfig.casServerUrlPrefix);
        myRealm.setCasService(ShiroConfig.shiroServerUrlPrefix + ShiroConfig.casFilterUrlPattern);
    ...
    public CasFilter getCasFilter() {
        ...
        casFilter.setFailureUrl(ShiroConfig.loginUrl);
